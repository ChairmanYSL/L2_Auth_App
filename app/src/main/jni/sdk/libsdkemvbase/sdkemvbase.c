...
void sdkEMVBase_ContactlessIsoCommand(EMVBASE_APDU_SEND * ApduSend, EMVBASE_APDU_RESP * apdu_r)
{
...

	{
...

		{
			...
			//PPSE
			{"00A40400", "325041592E5359532E4444463031","6F2F840E325041592E5359532E4444463031A51DBF0C1A61184F07A0000000651010500A4A4342204372656469748701019000"},
			//Select
			{"00A40400", "A0000000651010", "6F288407A0000000651010A51D500A4A4342204372656469749F380B9F52019F35019F02069C018701019000"},
			//GPO
...
s32 sdkEMVBaseEntryPoint(SDK_EMVBASE_CL_HIGHESTAID *tempHighestAID)
{
	...
	Trace("emv", "sdkEMVBaseEntryPoint ret = %d\r\n", sdk_rslt);
	return sdk_rslt;
}
...
s32 sdkEMVBaseLoadAIDListFromSzztSDK(void)
{
	...
	Trace("emv","Read SzztSDK AID size = %d\r\n", size);
	if(size % 1024 != 0)
	{
	...
	aidNum = size / 1024;
	Trace("emv","Read SzztSDK AID num = %d\r\n", aidNum);
	for(i = 0; i < aidNum; i++)
	{
